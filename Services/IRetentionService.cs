...
public interface IRetentionService
{
    ...
    Task<List<RetentionTrendPoint>> GetTrendAsync(string? store, string role, string? assignedName, string? om = null, string? oc = null, int? sinceYear = null);
    ...
    Task<List<ChartDataItem>> GetTenureDistributionAsync(string? store, string role, string? assignedName, string? om = null, string? oc = null, int? month = null, int? year = null);

    /// <summary>Same tenure buckets as above, broken out per store.</summary>
    Task<List<StoreTenureRow>> GetTenureDistributionByStoreAsync(string? store, string role, string? assignedName, string? om = null, string? oc = null, int? month = null, int? year = null);
